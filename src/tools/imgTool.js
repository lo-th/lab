    ...
    imgTool = {
        ...
        getPalette: function( sourceImage, colorCount, Quality ) {
            ...
            vibrants = {
                ...
                darkMuted : this.findColorVariation(r.lumTargetDark, 0, r.lumMaxDark, r.satTargetMuted, 0, r.satMaxMuted),
        ...
        findColorVariation: function( targetLuma, minLuma, maxLuma, targetSaturation, minSaturation, maxSaturation ) {

            var j, len, luma, maxValue, sat, c, value;
            var color = null;
            //max = 0;
            maxValue = 0;
