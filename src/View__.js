...
View.prototype = {
    ...
    getSun: function () { return this.sun; },
    getMoon: function () { return this.moon; },
	...
	setTone : function( o ) {
        ...
        for( var v in this.tone ) this.tone[v] = o[v] !== undefined ? o[v] : this.tone[v];

        this.renderer.physicallyCorrectLights = this.tone.correctLight;
        this.renderer.gammaInput = this.tone.gammaInput;
        this.renderer.gammaOutput = this.tone.gammaOutput;
        this.renderer.toneMapping = this.toneMappings[ this.tone.type ];
        this.renderer.toneMappingExposure = this.tone.exposure;
        this.renderer.toneMappingWhitePoint = this.tone.whitePoint;
